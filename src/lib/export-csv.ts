...
const COLUMNS: Array<{ header: string; get: (o: Order) => string }> = [
  ...
  { header: "Anexo fatura (sinal)",     get: (o) => o.invoice_url_sinal ?? "" },
  { header: "Anexo fatura (intermédio)",get: (o) => o.invoice_url_intermedio ?? "" },
  { header: "Anexo fatura (final)",     get: (o) => o.invoice_url_final ?? "" },
