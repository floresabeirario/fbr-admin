        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 leading-tight">
            ...
            {local.service_type === "emoldurar_secas" && (
              <span className="inline-flex items-center rounded-full bg-cocoa-900 px-1.5 py-0.5 text-[10px] font-semibold text-cream-50 uppercase tracking-wide shrink-0">
                Secas
              </span>
            )}
          </div>
