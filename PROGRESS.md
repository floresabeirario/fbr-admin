...
**Fase 6 — Integrações + PWA + RGPD (em curso).** Última sessão: **142** (2026-07-14, workbench: removidos "Próxima acção" e "Checklist da fase" a pedido da Maria).
...
> Sessões 127-137 movidas para o [PROGRESS-ARQUIVO.md](PROGRESS-ARQUIVO.md).
